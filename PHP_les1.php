<?php	__  ____  ____  ____  ____  ____  ____  ____  ____  ____  ____  __

#.htaccess в Apache
	Options Indexes FollowSymLinks
	DirectoryIndex Index.php
	php_flag register_long_arrays off
	//отключает автоэкранирование спецсимволов
	...
	serialize()						//Преобразует массив в строку с полной структурой
	unserialize()					//Преобразует строку в массив с полной структурой
...
__  ____  ____  ____  ____  ____  ____  ____  ____  ____  ____  __
	...
	floatval(expression)					//Возвращает вещественное значение аргумента.
		...
		explode									//Разбивает строку на подстроки - !!возвращает массив.
	...
	/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/	
		...
		<form action="<?=$_SERVER["SCRIPT_NAME"];?>" method="post">				//Заполнение action
		<input type="text" name="name"><br>
		</form>
		
		<form action="<?=$_SERVER["PHP_SELF"];?>" method="post">				//Заполнение action
		
		<form action="<?=$_SERVER["REQUEST_URI"];?>" method="post">				//Заполнение action для !!!форм
		
		
		$name = trim(strip_tags($_POST['name']));								//Фильтр
		echo "Вас зовут ".$name.
		...
		<input type="image" src="image.gif" name="sub" />						//изображение используется как кнопка
